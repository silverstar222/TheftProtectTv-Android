...
import com.esp.theftprotecttv.TheftProtectTvApplication;
...
public class Adapter {
    ...
    public void doPost(final String tag, String url,
        ...
        try {
                    ...
                    if (showAlert) {
                        if (error.networkResponse != null) {
                            ...
                            if (error.networkResponse.statusCode == 403) {
                                if (Pref.getValue(caller, Config.PREF_IS_REGISTER, 0) == 0)
                                {
                                    AlertDailogView
                                            .showAlert(
                                                    caller,
            ...
            TheftProtectTvApplication.getInstance().addToRequestQueue(apiReq, tag);
        } catch (Exception e) {
...
//
//            // Adding request to request queue
//            TheftProtectTvApplication.getInstance().addToRequestQueue(apiReq,
//                    tag);
//        } catch (Exception e) {
//            Log.error("Exception", e);
//            e.printStackTrace();
...
//    }
    ...
    public void doCancel(String tag) {
        try {
            TheftProtectTvApplication.getInstance().cancelPendingRequests(tag);
        } catch (Exception e) {
            Log.error("Exception", e);
        }
    }
